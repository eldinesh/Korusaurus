...
| Tag              | Use when...                                                        |
|------------------|--------------------------------------------------------------------|
| `[Inference]`    | You are drawing a logical conclusion not directly stated in source material |
...
**Escalation rule:** If *any part* of a response contains unverified content, flag this at the top of the response:
